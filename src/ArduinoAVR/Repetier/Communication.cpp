...
FSTRINGVALUE(Com::tZProbeBedDitance, "Max. z-probe - bed dist. [steps]")
...
FSTRINGVALUE(Com::tDeltaTowerA_xPos, "Tower A xPos [mm]")
FSTRINGVALUE(Com::tDeltaTowerA_yPos, "Tower A yPos [mm]")
FSTRINGVALUE(Com::tDeltaTowerC_xPos, "Tower C xPos [mm]")
FSTRINGVALUE(Com::tDeltaDiagonalA, "Diagonal A [mm]")
FSTRINGVALUE(Com::tDeltaDiagonalB, "Diagonal B [mm]")
FSTRINGVALUE(Com::tDeltaDiagonalC, "Diagonal C [mm]")
FSTRINGVALUE(Com::tDeltaTowerA_xTilt, "Tower A xTilt []")
FSTRINGVALUE(Com::tDeltaTowerA_yTilt, "Tower A yTilt []")
FSTRINGVALUE(Com::tDeltaTowerB_xTilt, "Tower B xTilt []")
FSTRINGVALUE(Com::tDeltaTowerB_yTilt, "Tower B yTilt []")
FSTRINGVALUE(Com::tDeltaTowerC_xTilt, "Tower C xTilt []")
FSTRINGVALUE(Com::tDeltaTowerC_yTilt, "Tower C yTilt []")
