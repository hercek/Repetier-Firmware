...
FSTRINGVAR(tTower2)
FSTRINGVAR(tTower3)
FSTRINGVAR(tDeltaTowerA_xPos)
FSTRINGVAR(tDeltaTowerA_yPos)
FSTRINGVAR(tDeltaTowerC_xPos)
FSTRINGVAR(tDeltaDiagonalA)
FSTRINGVAR(tDeltaDiagonalB)
FSTRINGVAR(tDeltaDiagonalC)
FSTRINGVAR(tDeltaTowerA_xTilt)
FSTRINGVAR(tDeltaTowerA_yTilt)
FSTRINGVAR(tDeltaTowerB_xTilt)
FSTRINGVAR(tDeltaTowerB_yTilt)
FSTRINGVAR(tDeltaTowerC_xTilt)
FSTRINGVAR(tDeltaTowerC_yTilt)
